...
class DataService():
    ...
    def load_data_to_redis(self, embeddings):
        ...
        text_embedding = VectorField("vector", "FLAT", {"TYPE": "FLOAT32", "DIM": vector_dim, "DISTANCE_METRIC": "COSINE", "INITIAL_CAP": vector_number,})
        ...
        try:
            ...
            self.redis_client.ft(INDEX_NAME).create_index(fields = fields, definition = IndexDefinition(prefix=[PREFIX], index_type=IndexType.HASH))
    ...
    def search_redis(self, user_query: str, index_name: str = INDEX_NAME, vector_field: str = "vector", return_fields: list = ["text", "vector_score"], hybrid_fields = '*', k: int = 5, print_results: bool = False,):
